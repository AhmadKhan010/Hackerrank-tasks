...
This repository contains solutions to various HackerRank tasks that were solved during the Rakurai training.

## About the Solutions

For many of the problems, there are multiple versions of the solution provided (e.g., `v1.rs`, `v2.rs`, `v3.rs`). 
Each subsequent version represents a more optimized or refactored approach compared to the previous one. The optimizations typically improve time complexity, space complexity, or code cleanliness and readability.
...
To run these solutions, simply copy the code from the desired file and paste it into the code editor for the respective task on HackerRank. HackerRank will automatically compile and run the code against its suite of test cases when you click "Run Code" or "Submit Code".
